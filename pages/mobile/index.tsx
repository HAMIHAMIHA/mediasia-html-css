...
import Email from "../../styles/src/svg/mail_mobile.svg"
...
const Block1_1 = ({text0, text1, text2, text3, text4, text5, propramme,introduce}: Block1_1Props) => {
    ...
    return (
    <div className="mblock1_1">
        <div className="topBox">
            <div className="logo">
                <Image src={src_logo_purple} width={300} height={300} className="picture"/>
            </div>
...
const EmptyBlock=()=>{
    ...
    // useEffect(() => {
    // document.documentElement.style.fontSize = (width / 390) + 'px'
    // }, [width])
